...
export ARCH="arm"
export START_PATH=~/
export SOURCE_PATH=$START_PATH"/navit-git/"
...
export ANDROID_SDK="/opt/android-sdk-r25.2.5-linux/"
...
export ANDROID_SDK_HOME=/opt/android-sdk-r25.2.5-linux
export ANDROID_HOME=/opt/android-sdk-r25.2.5-linux
